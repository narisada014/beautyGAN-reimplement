...
class Generator_makeup(nn.Module):
    ...
    def forward(self, x, y):
        ...
        """
        xをオリジナル画像。yを参照画像とした場合、xとyをx方向に結合した画像をinput_xとして、それをまずニューラルネットワーク（Encoder-Decoder）に入力する。
        そのネットワークのDecoderの出力をbranch_1, branch_2に入力し、2種類のジェネレーターから2種類の生成画像out_A, out_Bを得る。
        """
